...
import dev.paie.config.JeuxDonnesBulletinConfig;
...
@ContextConfiguration(classes = { PaieUtils.class, JeuxDonneesConfig.class, ServicesConfig.class, JeuxDonnesBulletinConfig.class })
